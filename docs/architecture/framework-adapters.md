...
1. Raw Python decorators / context managers (`adapters/python` + `sdk`)
2. OpenTelemetry bridge (`adapters/otel`)
3. LangGraph adapter
...
Only (1) and a placeholder for (2) are scaffolded in this repository. Later adapters are **planned**, not implemented.
